# -*- coding: utf-8 -*-
"""
Created on Sun Apr 15 12:55:20 2018
...
def test_model_on_single_file(file_path):
    clf = joblib.load('saved_models/model_kmeans.pkl')
    ...
    # x=X[:30000]
    # print(x.shape)
    predicted_output = clf.predict(X)
...
if __name__ == "__main__":
    ...
    test_file = "C:/Users/srujana/Desktop/genre-test/classical/classical.00000.wav"            
